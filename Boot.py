...
def Boot():
    print("""
      ...
      0J  k _@   9g_ j#"   "b_  j#"   "b_ _d"   q_ g  ##            Modular CLI Project V01
      #F  `NF     "#g"       "Md"       5N#      9W"  j#            By Co1dtuna / Stockastic
      #k  jFb_    g@"q_     _*"9m_     _*"R_    _#Np  J#            2022
    ...
    time.sleep(1.3)
    print("Cocinando Cereal")
    time.sleep(1.3)
    print("Pedro paciente...")
    time.sleep(1.2)
